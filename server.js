...
app.get("/list", (request, response) => {
  var sqlQuery = `SELECT * FROM ganta_veeranna`;
...
app.post("/create", (request, response) => {
  ...
  var sqlQuery = `INSERT INTO ganta_veeranna (name, age, location, email, blood_group) VALUES ('${name}', ${age}, '${_location}', '${email}', '${blood_group}')`;
...
app.put("/edit/:id", (request, response) => {
  ...
  var sqlQuery = `UPDATE ganta_veeranna SET name='${name}', age=${age}, location='${_location}', email='${email}', blood_group='${blood_group}' WHERE id=${id}`;
...
app.delete("/delete/:id", (request, response) => {
  ...
  var sqlQuery = `DELETE FROM ganta_veeranna WHERE id=${id}`;
